...
<style style="text/css">
	...
	<div id="" style="margin:auto; margin-top: 20px; font-size: 1.2em; margin:
              ...
              class="col-md-12">
                <h3 style="color:#03F;">จัดการคิวโชว์รางวัล</h3>
...
<script type="text/javascript">  
	control_person_listUnitCase1();
	function control_person_listUnitCase1()
	{
					...
					if (data[0].result === "true") 
							{
								...
								for (var i = 1; i < data.length; i++) 
								{
									...
									col[0] = i;
									col[1] = data[i]["unit_case"];
									col[2] = '<button class="btn btn-info" onclick="select_random1(\''+data[i]["unit_case"]+'\');" ><span class="glyphicon glyphicon-hand-left"></span></button>';
	...
	function select_random1(unit_show)
	{
		//alert(unit);
		$("#select_unit1").html(unit_show);
		$.ajax({
				url:"file/f_control_littleaward.php",
				type:"post",
				data:'unit_show='+unit_show+"&Vmode=CalldataRandom",
				success:function(data){
					console.log(data);
				},
			});
