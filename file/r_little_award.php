...
$txt = "";
		  ...
		  ';
			...
			$ReadTable = $dataBuff->SQL_Select("	
													 ...
													 order by gift_little.id
											");	

					while ($row = $ReadTable->fetch_assoc()) 
					{
						$html.='<tr><td width="40" align="right">'.++$i.'&nbsp;&nbsp;</td><td width="200">&nbsp;'.$row['g_name'].'</td><td width="120">&nbsp;'.$row['unit_show'].'</td><td width="200">&nbsp;'.$row['p_name'].'</td><td></td>'.'</tr>';
					}
