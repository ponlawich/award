...
<style>
    ...
    <div style="position:relative;">
    	<font style="position:relative; color:#0FF; text-shadow: 1px 1px 2px black, 0 0 25px white, 0 0 5px blue;" size="13" id="p_random_superaward_start_name"><?PHP //echo $AvNumber." ".$AvName;?><?PHP echo $AvName;?></font>
   	</div>    
	...
	function  p_random_superaward_start_ImgChange()
	{
		$("#p_random_superaward_start_bStart").attr("src","imageuse\\accessory\\b_red.png"); 
			...
			$.post("file/f_p_random_superaward_start.php",
				...
				function(result)
				{
						$.post("file/p_random_superaward_show2.php",
						{				
							VawardID	: <?PHP echo $AvNumber;?>
						},
						function(data)
