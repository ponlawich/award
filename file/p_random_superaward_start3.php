...
<style>
    ...
    <div style="position:relative;">
    	<font face="TH Mali" style="position:relative; color:#0FF; text-shadow: 1px 1px 2px black, 0 0 25px white, 0 0 5px blue;" size="13" id="p_random_superaward_start_name"><?PHP //echo $AvNumber." ".$AvName;?><?PHP echo $AvName;?></font>
   	</div>    
