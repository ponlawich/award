...
///////////////////////////////////////////////////////////////
			$ReadTable = $dataBuff->SQL_Select("	
												 ...
												 from person
												 where unit_show like '%$vushow%'
											");		
			$personName = "";
			while($row = $ReadTable->fetch_assoc())
			{
				$personName .= $row['pname'].'<br>';
			}
...
<style>
	...
	<div style=" position:absolute;">
    		<img src="imageuse/random/ld1.gif" id="p_random_superaward_bg" style="filter: opacity(0.8);" onerror="this.src='imageuse/random/ld0.gif';"/>
    </div>
    ...
    <p>
    	<font size="8" id="p_random_superaward_name" style="position:relative; color:#FFD700; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;"></font>
   	</p>
    <p>
    	<font size="8" id="p_random_superaward_unit" style="position:relative; color:#FF1493; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;" ></font>
  	</p>
    ...
    <p id="p_random_superaward_maqPersonname" style="position:relative; display: none;">   
        <marquee direction="up" scrollamount="45" id="p_random_superaward_maqPanelperson">>
                <?PHP
                    echo '<font style="color:#FFD700; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; text-align: center;">'.$personName.'</font>';
                ?>
        </marquee>
    </p>
...
<script type="text/javascript">     
	...
	$("#p_random_superaward_maq").attr("width",Vh*0.3+" px;");
	$("#p_random_superaward_maqPanelperson").attr("height",Vh*0.9+" px;");
	$("#p_random_superaward_maqPanelperson").attr("width",Vh*0.98+" px;");
	...
	$("#p_random_superaward_unit").offset({ top: Vh*0.05});
	...
	function p_random_superaward_set()
	{
		setTimeout(
					function()
					{
						...
						$("#p_random_superaward_maqPanel").hide();
						$("#p_random_superaward_unit").html("<?PHP echo '<font style=\"font-size: 200px;\">'.$vushow.'</font>'; ?>");
						$("#p_random_superaward_unit").show();					
					}, 3000);
		setTimeout(
					function()
					{
						$("#p_random_superaward_unit").hide();	
						$("#p_random_superaward_maqPersonname").show();				
						//$("#p_random_superaward_name").html("<?PHP //echo '<label style=\"font-size: 200px;\">'.substr($vname,0, strpos($vname,' ')).'</label>'; ?>");
		...
		setTimeout(
					function()
					{
						$("#p_random_superaward_maqPersonname").hide();	
